...
import { Brain, Sparkles, BarChart2 } from "lucide-react"
  ...
  const facts = [
    {
      title: "¿Por qué SOMA?",
      description:
        "SOMA toma su nombre del soma neuronal, el cuerpo celular de la neurona donde se procesa la información. Así como el soma es el núcleo de la neurona, nuestra app es el núcleo de tu bienestar del sueño.",
      icon: "brain",
    },
    {
      title: "Tecnología y ciencia",
      description:
        "Combinamos la neurociencia del sueño con tecnología avanzada para ayudarte a desarrollar hábitos saludables que transforman tu descanso.",
      icon: "sparkles",
    },
    {
      title: "Resultados comprobados",
      description:
        "Nuestros usuarios mejoran su calidad de sueño en un 40% después de solo 2 semanas de uso consistente de SOMA.",
      icon: "bar-chart-2",
    },
  ]
        ...
        <div className="container mx-auto px-4">
            ...
            {facts.map((fact, index) => (
              ...
              >
                <div className="flex items-center justify-center w-16 h-16 mb-6 rounded-full bg-secondary/20 mx-auto">
                  ...
                  {fact.icon === "bar-chart-2" && <BarChart2 className="h-6 w-6 text-foreground" />}
                </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-xl text-foreground mb-8 max-w-3xl mx-auto">
              SOMA te ayuda a mejorar tus hábitos de sueño a través de técnicas respaldadas por la ciencia, monitoreo
              personalizado y recomendaciones adaptadas a tu ritmo de vida.
            </p>
